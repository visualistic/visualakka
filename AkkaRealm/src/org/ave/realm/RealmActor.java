    ...
    extends VisualActor
{
    ...
    protected void postInitialize() {
        ...
        Props UserCodeBlocks8_decl = Props.create(org.ave.realm.RealmActor.class, new org.ave.realm.RealmActor.Creator(new VisualProps(getPath(), "Resume", 2147483647, "-1"), "_UCB_GenerateCitizens", new String[] { }));
